...
import com.agh.emt.utils.form.ErasmusDestination;
...
public class ParameterService {
    ...
    private void deletAllFromEdition(String edition){
        userRepository.findAll().stream()
                ...
                .forEach(user -> {user.getRecruitmentForms()
                        .removeIf(recruitmentForm -> recruitmentForm!=null && recruitmentForm.getOneDriveFormPath()!=null && recruitmentForm.getOneDriveFormPath().contains(edition));
                    userRepository.save(user);
                });
        recruitmentFormRepository.findAll()
                .removeIf(recruitmentForm -> recruitmentForm==null || recruitmentForm.getOneDriveFormPath().contains(edition));
    }
